...
public class TabMainActivity extends TabActivity implements OnTabChangeListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		searchspec.setIndicator("", getResources().getDrawable(R.drawable.ic_action_search));
		...
		// setting Title and Icon for the Tab
		browsespec.setIndicator("", getResources().getDrawable(R.drawable.ic_action_browse));
		...
		// setting Title and Icon for the Tab
		cameraspec.setIndicator("", getResources().getDrawable(R.drawable.ic_action_camera));
		...
		// setting Title and Icon for the Tab
		profilespec.setIndicator("", getResources().getDrawable(R.drawable.ic_action_profile));
		...
		// setting Title and Icon for the Tab
		newsspec.setIndicator("", getResources().getDrawable(R.drawable.ic_action_news));
        ...
        tabHost.getTabWidget().getChildAt(0).setBackgroundColor(Color.parseColor("#cccbc1"));
	}
	...
	public void onTabChanged(String tabId) {
		...
		tabHost.getTabWidget().getChildAt(tabHost.getCurrentTab()).setBackgroundColor(Color.parseColor("#cccbc1"));
	}
